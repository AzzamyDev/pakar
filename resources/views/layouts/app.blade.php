                        ...
                        @else
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item me-3">
                                    <a class="nav-link @if (Route::is('diseases.index')) active @endif" aria-current="page"
                                        href="{{ route('diseases.index') }}"><span><i class="fas fa-bacteria"></i></span>
                                        Penyakit</a>
                                </li>
                                <li class="nav-item me-3">
                                    <a class="nav-link @if (Route::is('indications.index')) active @endif" aria-current="page"
                                        href="{{ route('indications.index') }}"><span><i
                                                class="fab fa-creative-commons-sampling"></i></span> Gejala</a>
                                </li>
                                @role('admin')
                                    <li class="nav-item me-3">
                                        <a class="nav-link @if (Route::is('psikologs.index')) active @endif" aria-current="page"
                                            href="{{ route('psikologs.index') }}"><span><i class="fas fa-users"></i></span>
                                            Psikolog</a>
                                    </li>
                                    <li class="nav-item me-3">
                                        <a class="nav-link @if (Route::is('users.index')) active @endif" aria-current="page"
                                ...
                                @endrole
                                <li class="nav-item me-3">
                                    <a class="nav-link @if (Route::is('record')) active @endif" aria-current="page"

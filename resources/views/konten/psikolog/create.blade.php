            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-secondary">Tambah Psikolog</h5>
                        @if (session('update'))
                        ...
                        <form action="{{ route('psikologs.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input autocomplete="off" type="text" class="form-control" id="name"
                                    placeholder="Masukan Nama Psikolog" name="name" value="{{ old('name') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input autocomplete="off" type="text" class="form-control" id="no_telpon"
                                    placeholder="Masukan Nomer Telepon" name="no_telpon" value="{{ old('no_telpon') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea autocomplete="off" type="text" class="form-control" id="alamat"
                                    placeholder="Masukan Alamat" name="alamat">{{ old('alamat') }}</textarea>
                                <span class="text-danger">@error('alamat')
                                        {{ $message }}
                                    @enderror</span>
                            </div>
                            <span class="text-secondary mb-3"><i class="fas fa-key"></i> Password Default :
                                123456789</span>

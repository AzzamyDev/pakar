                        ...
                        <form action="{{ route('rules.update', $data->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="penyakit_id" name="penyakit_id" class="custom-select">
                                    ...
                                    @foreach ($penyakit as $item)
                                        <option {{ $data->penyakit_id == $item->id ? 'selected' : '' }}
                                            value="{{ $item->id }}">
                                            {{ $item->nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="gejala_id" name="gejala_id" class="custom-select">
                                    ...
                                    @foreach ($gejala as $item)
                                        <option {{ $data->gejala_id == $item->id ? 'selected' : '' }}
                                            value="{{ $item->id }}">{{ $item->nama_gejala }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="nilai_pakar" name="nilai_pakar" type="number" max="1" min="0" step="0.1"
                                    class="form-control" value="{{ $data->nilai_pakar }}">
